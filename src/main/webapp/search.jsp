...
<body>
						...
						<ul>
							...
							<c:if test="${sessionScope.login == null }">
										<a href="loginServlet">Login</a>
											...
											<c:if test="${sessionScope.login != null }">
										 <a href="logoutServlet">Logout(${sessionScope.login.username})</a></c:if>
							...
							<li><form action="searchServlet" method="post"><input type="text" name="txtSearch" placeholder="Search.." value="${param.txtSearch }">
 ...
 -->
			...
			<div class="product_section_2 layout_padding">
				<div class="row"><c:set var="txt" value="${param.txtSearch }"/>
