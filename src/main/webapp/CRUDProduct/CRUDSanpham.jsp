...
<nav class="navbar navbar-default navbar-fixed-top ">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li  class="nav-item" onclick="setActive(this)"><a href="ReadAccount" data-toggle="tooltip"
						data-placement="bottom" title="KHÁCH HÀNG">ACCOUNT</a></li>
					<li   class="nav-item"onclick="setActive(this)"><a href="ReadServlet" data-toggle="tooltip"
						data-placement="bottom" title="SẢN PHẨM">PRODUCT</a></li>

					<li class="nav-item" onclick="setActive(this)"><a href="ReadOder" data-toggle="tooltip"
						data-placement="bottom" title="danh sách đơn hàng">ORDER</a></li>



					<li  class="nav-item"onclick="setActive(this)"><a href="#" data-toggle="tooltip" data-placement="bottom"
						title="TÀI KHOẢN">FEATURE<span class="caret"></span>
					</a>
						<ul class="dropdown">
	...
	<div class="container-fluid al">
		...
		<Br>
		<form action="searchspServlet" method="post">
	...
	<Br>
		...
		<table class="table table-bordered" id="myTable">
			...
			<tbody>
				<c:forEach var="e" items="${listProduct}">

					<tr>
						<td>${e.id}</td>
						<td>${e.name}</td>
						<td>${e.description}</td>
						<td><img src="${e.image}" width="100" height="150" alt=""></td>
						<td>${e.price}</td>
						<td>${e.quantity}</td>
						<td>${e.category}</td>

						<td><a href="updateServlet?id=${e.id}" class="edit"
							title="Sửa" data-toggle="tooltip"> <i class="fa fa-pencil"
								aria-hidden="true"></i></a> <a href="deleteServlet?id=${e.id}"
							class="" title="Xóa" data-toggle="tooltip"
	...
	<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            jQuery(function () {
                jQuery(".add").click(function () {let isSuccess = false; if (isSuccess) {
                    swal("Thành Công!", "Bạn Đã Sửa Thành Công", "success");
                }else {
                    swal("Thất Bại", "Sửa không thành công", "error");
                }
                });
            });
            // Xóa
            $(document).on("click", ".delete", function () {
                ...
                } else { swal("Thành Công!", "Bạn Đã Xóa Thành Công", "success");
                $(".add-new").removeAttr("disabled");
