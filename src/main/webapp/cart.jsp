			...
			<div class="row w-100">
				<div class="col-lg-12 col-md-12 col-12">
					<h3 class="display-5 mb-2 text-center"
						style="padding-top: 60px; font-size: 40px">Shopping Cart</h3>
					...
					<table class="table table-condensed table-responsive">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="buttons_added"><a class="minus is-form"type="button"
														href="QuanlityIncDec?action=inc&id=<%=c.getId()%>"style="text-align: center;">+</a>
									
										<input aria-label="quantity" class="input-qty" value="<%=c.getQuantity()%>"
											autocomplete="off" size="2" type="text"><a type="button"
														class="plus is-form" style="text-align: center;"
														href="QuanlityIncDec?action=dec&id=<%=c.getId()%>">-</a>
									</div>
					...
					<div class="float-right text-right">
						<h4>Subtotal:</h4>
						<h1>${(total>0)?dcf.format(total):0}</h1>
					</div>
				</div>
			</div>
