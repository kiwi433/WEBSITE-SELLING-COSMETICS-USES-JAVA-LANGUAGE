					...
					<div class="side-bar">
						<div class="user-info">
							...
							<%-- <ul class="meta list list-unstyled">
								<li class="name">${user.fullname}<label
									class="label label-info">${user.position}</label>
								</li>
								...
								<div class="form-group">
									...
									<div class="col-xs-4 male">
										<input type="radio" name="gioitinh" value="1"
											readonly="readonly" ${user.gender == true?"checked":"" }>Nam
									</div>
									<div class="col-xs-4 female">
										<input type="radio" name="gioitinh" value="0"
											readonly="readonly" ${user.gender == false?"checked":"" }>Nữ
									</div>
								</div>

								<div class="form-group">
									<label class="col-md-2 col-sm-3 col-xs-12 control-label">Full
										Name</label>
									<div class="col-md-10 col-sm-9 col-xs-12">
										<input type="text" class="form-control"
											value="${user.fullname}">
								...
								<div class="form-group">
									...
									<div class="col-md-10 col-sm-9 col-xs-12">
										<input type="email" class="form-control"
											value="${user.address}">
										<p class="help-block">This is address</p>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-10 col-sm-9 col-xs-12">
										...
										<p class="help-block">This is phone number</p>
									</div>
								</div>
							</fieldset>
							<hr>
