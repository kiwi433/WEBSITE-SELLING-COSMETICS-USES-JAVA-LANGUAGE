		...
		<form action="signupServlet" method="post">
			<div class="con">
				<header class="head-form">
					<h2>Sign Up</h2>
					<p>Signup here </p>
					<div class="group"><p style="color: green;">${messe}</p></div>
					<div class="group"><p style="color: red;">${mess}</p></div>
				</header>
				<br>
				<div class="field-set">
					<!--   user name -->
					...
					<input class="form-input" type="password" name="txtConfirm"
						placeholder="Confirm" id="pwd">

					<!--      Show/hide password  -->
					<span> <i class="fa fa-eye" aria-hidden="true" type="button"
						id="eye"></i> <c:if test="${not empty errors.confirmNotMatch}">
