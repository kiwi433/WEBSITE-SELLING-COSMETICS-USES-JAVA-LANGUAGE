			...
			<div class="con">
				...
				<div class="field-set">
					...
					<input class="form-input" type="password" name="txtConfirm"
						placeholder="Confirm" id="pwd1">

					
					<br><c:if test="${not empty errors.confirmNotMatch}">
					...
					<span class="input-item"> <i class="fa fa-user"></i>
						...
						value="${param.txtUsername }"><br><br>
						 <span
						class="input-item"><i class="fa-solid fa-phone"></i>
					</span> <input class="form-input" type="text"
						name="phone" placeholder="Phone number"
						value="${param.txtUsername }"><br> <br>
						<span
						class="input-item"> <i class="fa-sharp fa-solid fa-location-dot"></i>
					</span><input class="form-input"  type="text"
						name="address" placeholder="Address"
						value="${param.txtUsername }"><br> <br>
						<span
						class="input-item"> <i class="fa-solid fa-venus-mars"></i>
					</span><input class="form-input"  type="text"
				...
				<div class="other">
					...
					<button class="btn submits sign-up">
						<a href="loginServlet">Back</a> <i class="fa fa-user-plus"
							aria-hidden="true"></i>
					</button>
...
<script type="text/javascript">
	function show() {
		...
		p.setAttribute('type', 'text');	p1.setAttribute('type', 'text');
	}

	function hide() {
		var p = document.getElementById('pwd');	var p1 = document.getElementById('pwd1');
		p.setAttribute('type', 'password');p1.setAttribute('type', 'password');
	}
