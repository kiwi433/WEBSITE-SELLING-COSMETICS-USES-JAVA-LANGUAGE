			...
			<div class="con">
				...
				<div class="field-set">
					...
					<input class="form-input" id="txt-input" type="text"
						name="txtUsername" placeholder="UserName(3- 10 chars)"required="required"
					...
					<!--   Password -->
					<br> <span class="input-item"> <i class="fa fa-key"></i>
					</span>
					<!--   Password Input-->
					<input class="form-input" type="password" name="txtPassword"
						placeholder="Password(3- 10 chars)" id="pwd"required="required">
					<!--      Show/hide password  -->
					...
					<!--   Password Input-->
					<input class="form-input" type="password" name="txtConfirm"
						placeholder="Confirm" id="pwd1"required="required"> <br>
					...
					<!--        buttons -->
					<!--      button LogIn -->
					<span class="input-item"> <i class="fa fa-user"></i>
					</span><input class="form-input" type="text" name="fullname"
						placeholder="FullName"required="required"><br>
					<br> <span class="input-item"><i
						class="fa-solid fa-phone"></i> </span> <input class="form-input"
						type="text" name="phone" placeholder="Phone number"required="required"><br>
					<br> <span class="input-item"> <i
						class="fa-sharp fa-solid fa-location-dot"></i>
					</span><input class="form-input" type="text" name="address"
						placeholder="Address"required="required"><br> <br>

					<div class="form-group">
						<i class="fa-solid fa-venus-mars"></i>
						<div class="form-group">
							<div class="col-xs-2 male">
								<input type="radio" name="gender" id="gender" value="1"
									required="required">Male
							</div>

							<div class="col-xs-2 female">
